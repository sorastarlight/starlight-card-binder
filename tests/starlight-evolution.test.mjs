...
test('Starlight Evolution costs and refunds match the locked ladder', () => {
  ...
  assert.equal(prestigeFrameImageUrl('star_bit'), 'site_assets/Radiance1.png?v=3.0');
  assert.equal(prestigeFrameImageUrl('protostar'), 'site_assets/Radiance2.png?v=3.0');
  assert.equal(prestigeFrameImageUrl('starlight'), 'site_assets/Radiance3.png?v=3.0');
  assert.equal(prestigeFrameImageUrl('super_starlight'), 'site_assets/Radiance4.png?v=3.0');
  assert.equal(prestigeFrameImageUrl('starlight_burst'), 'site_assets/Radiance5.png?v=3.0');
