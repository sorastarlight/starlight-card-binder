...
test('Starlight Evolution migration and client wiring are present', async () => {
  ...
  assert.match(evoPage, /starlight-evolution-page\.js\?v=1\.8\.0/);
  assert.match(evoPage, /starlight-evolution\.css\?v=1\.9\.0/);
  ...
  assert.doesNotMatch(evoPageJs, /playFlairSequence|buildStackLayerMarkup|is-charging/);
