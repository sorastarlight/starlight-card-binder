...
test('Starlight Evolution migration and client wiring are present', async () => {
  ...
  assert.match(reveal, /anchorOverlayToVisibleViewport|prepareEmbedRevealViewport/);
  assert.match(reveal, /starlight-evolution-reveal\.css\?v=2\.4\.0/);
  ...
  assert.match(evoPage, /starlight-evolution-page\.js\?v=1\.3\.3/);
