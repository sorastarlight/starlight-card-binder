...
const routes = {
  ...
  'admin-boosters.html':'admin-boosters','admin-twitch.html':'admin-twitch','admin-gifts.html':'admin-gifts','admin-news.html':'admin-news','admin-notifications.html':'admin-notifications','admin-users.html':'admin-users'
};
