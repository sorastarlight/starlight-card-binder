...
Season Pass Name Color (pink/gold gradient)`,
    ...
    trades: {
      ...
      listedTitle: 'Listed For Trade',
      listedLead: 'These duplicate copies are visible to other collectors browsing your profile.',
      albumTitle: 'Your Collection',
      albumLead: 'Click a duplicate card to offer it for trade, then set how many copies to list. Your first copy of each card stays protected.',
      listedEmptyTitle: 'Nothing listed yet',
      listedEmptyLead: 'Use your collection album below to offer duplicate copies for trade.',
