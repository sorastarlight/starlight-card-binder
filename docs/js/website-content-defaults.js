...
export function createDefaultWebsiteContent() {
  return {
    ...
    daily: {
      ...
      disabledTitle: 'Daily Booster Is Currently Disabled',
      disabledLead: 'The Daily Booster has been paused by the site administrator.',
      resultsTitle: "Here Are Today’s Daily Booster Results",
