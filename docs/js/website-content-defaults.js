...
Season Pass Name Color (pink/gold gradient)`,
    ...
    trades: {
      ...
      lead: 'Find collectors to trade with, then manage the cards you want and the duplicates you are offering — all in one place.',
      hubTabCollectors: 'Find Collectors',
      listsLeadWishlist: 'Mark cards you are searching for. Other collectors can see this list when public trade lists are enabled on your profile.',
      listsLeadTrade: 'Offer only duplicate copies for trade. Your permanent first copy of each card stays protected.',
      listsLeadAll: 'Browse every card to add items to your wishlist or for-trade list.',
