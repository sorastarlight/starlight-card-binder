...
export function createDefaultWebsiteContent() {
  return {
    ...
    binderLanding: {
      ...
      title: 'Starlight Card Gallery',
      lead: 'Browse every card in the series. Uncollected cards stay face-down until you earn them.',
    ...
    collection: {
      ...
      emptyAllLead: 'Earn cards from Daily Boosters, redemption codes, and special rewards to fill your album binder.',
    ...
    starlightEvolution: {
      eyebrow: 'My Stuff',
      title: 'Evolve My Cards',
      tagline: 'Infuse duplicate cards with Starlight Energy to awaken their true brilliance.',
      howTitle: 'How Evolution works',
      howLead: 'Gather duplicate extras, pick a card below, and confirm Evolve. Duplicates orbit, burst, and reveal a richer Radiance frame.',
      tiersLegendEyebrow: 'Starlight Evolution',
      tiersLegendTitle: 'Radiance tiers',
      tiersLegendLead: 'Each Evolution step spends duplicate extras and keeps one protected copy. Frames grow richer from Radiance I through the holographic Radiance V crown.',
      ...
      readyLead: 'Standard cards with enough duplicate extras for their next Radiance step appear here. Tap a card to Evolve in place.',
      readyEmpty: 'No cards are ready right now. Gather more duplicate extras in your album, then check back here.',
      ownedTitle: 'Your evolved cards',
      ownedLead: 'Cards at Radiance I or higher live here. Open one to Evolve again or Unfuse extras.',
      ownedEmpty: 'No evolved cards yet. When a card is ready below, Evolve it to see its Radiance frame here.',
      collectionCta: 'Open My Card Album Binder',
