...
export function createDefaultWebsiteContent() {
  return {
    ...
    starlightEvolution: {
      ...
      howLead: 'Open a card in My Card Collection, then Evolve when you have enough duplicate extras. Each step spends extras and keeps one protected copy.',
      ...
      collectionCta: 'Open My Collection',
      stardust: '★ Stardust',
