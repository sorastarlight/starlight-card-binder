...
Season Pass Name Color (pink/gold gradient)`,
    ...
    trades: {
      ...
      albumLead: 'Use the Offer for trade switch on any duplicate, then set how many copies to list. Your first copy of each card stays protected.',
      listedEmptyTitle: 'Nothing listed yet',
      listedEmptyLead: 'Turn on “Offer for trade” below to list duplicate copies.',
