...
export const WEBSITE_EDITOR_TABS = Object.freeze([
  ...
  { id: 'daily', label: 'Free Daily Starlight Pack' },
  { id: 'shop', label: 'Shop' },
  { id: 'events', label: 'Events' },
  { id: 'redeem', label: 'Redeem Code' },
  { id: 'collection', label: 'My Collection' },
  { id: 'starBits', label: 'Star Bits' },
  { id: 'checklist', label: 'Card Checklist' },
  { id: 'quests', label: 'Missions' },
  { id: 'seasonPass', label: 'Season Pass' },
  { id: 'trades', label: 'Trade' },
  { id: 'offers', label: 'Trade' },
  { id: 'notifications', label: 'Notifications' },
  { id: 'rewards', label: 'Gifts' },
...
export function createDefaultWebsiteContent() {
  return {
    ...
    home: {
      ...
      primaryCta: '✨ Open Free Daily Starlight Pack',
      secondaryCta: '🗂️ Browse Card Gallery',
      quickLinks: [
        { id: 'collection', label: '♡ My Collection' },
    ...
    binderLanding: {
      ...
      title: 'Card Gallery',
      lead: 'Browse every officially released card. Tap a card to view it fullscreen.',
      ...
      backToSeriesCta: '← All Series',
      gridBrowseLead: 'Browse the cards in this set.',
    ...
    daily: {
      ...
      signInTitle: 'Sign In to Claim Your Free Pack',
      signInLead: 'Free Daily Starlight Packs and Star Bits boosters are saved to your Starlight account.',
      signInCta: 'Sign In to Open',
      morePacksEyebrow: 'Keep the magic going',
      morePacksTitle: 'Want to open more packs?',
      morePacksLead: 'Extra cards are never wasted. Convert duplicate cards into Star Bits, then spend them in the Shop for more chances to pull Rare, Epic, and Legendary cards.',
      convertCta: 'Convert Extras',
      shopCta: 'Visit Shop',
      readyPackLabel: 'READY TO OPEN - CLICK THE PACK',
      readyTitle: 'Your Free Pack Is Ready!',
      readyLead: "Click the pack to view today's cards.",
      claimedPackLabel: 'Free Pack Claimed',
      claimedTitle: 'Your Next Free Pack Is Charging',
      claimedLead: 'The portal will awaken again at midnight Eastern Time.',
      disabledPackLabel: 'Free Pack Unavailable',
      disabledTitle: 'Free Daily Starlight Pack Is Currently Disabled',
      disabledLead: 'The Free Daily Starlight Pack has been paused by the site administrator.',
      resultsTitle: "Here Are Today’s Free Daily Starlight Pack Results",
    ...
    redeem: {
      ...
      returnCta: 'Return to Gallery'
    },
    collection: {
      eyebrow: 'My Stuff',
      title: 'My Collection',
      lead: 'Your personal binder of collected Starlight cards. Themes and covers unlock as you level up.',
      tabAll: 'Collected Cards',
      tabFavorites: 'Favorites',
      tabDuplicates: 'Duplicates',
      allEyebrow: 'My Binder',
      allTitle: 'Collected Cards',
      allLead: 'Cards you own, displayed in your Starlight album binder.',
      binderSpreadTitle: 'Binder Spread',
      binderSpreadLead: 'Tap a card for full view, favorites, and trade actions.',
      binderThemeNote: 'Classic Starlight theme',
      ...
      duplicatesCta: 'Open Star Bits',
      emptyAllTitle: 'No cards here yet',
      emptyAllLead: 'Earn cards from Free Daily Starlight Packs, redemption codes, and special rewards to fill your album binder.',
      emptyAllCta: 'Open Card Gallery',
      ...
      emptyFavoritesCta: 'Open Card Gallery',
      emptyFiltersTitle: 'No cards match these filters',
    ...
    starBits: {
      ...
      emptyLead: 'Your extra copies will appear here after opening Free Daily Starlight Packs and reward packs.',
...
Season Pass Name Color (pink/gold gradient)`,
      ...
      exclusivePromoHelp: 'This exclusive Starlight card cannot be pulled from regular boosters. Subscribe on Twitch during the season to unlock it through your Season Pass rewards.',
      ...
      pendingLead: 'Subscribe on Twitch, then open your Season Pass unlock gift in Gifts to activate.',
      ...
      subscriberLockedLead: 'This season is for active Twitch subscribers. Link Twitch and subscribe to unlock the free track. New subs also receive a Season Pass unlock gift in Gifts.',
      linkTwitchCta: 'Link Twitch',
      openGiftsCta: 'Open Gifts'
    },
    trades: {
      eyebrow: 'Collector Exchange',
      title: 'Trade',
      lead: 'Find collectors, list duplicates for trade, propose exchanges, and track your offers — all in one place.',
      hubTabCollectors: 'Find Collectors',
      hubTabMyTrade: 'My Cards For Trade',
      hubTabOpenTrades: 'Browse Open Trades',
      hubTabProgress: 'My Trades In-Progress',
      openTradesTitle: 'Browse Open Trades',
      openTradesLead: 'Browse collectors who currently have cards listed for trade.',
      openTradesSearchLabel: 'Search collectors',
      openTradesSearchPlaceholder: 'Display name or username…',
      openTradesLoadingTitle: 'Loading open trades…',
      openTradesLoadingLead: 'Checking which collectors have cards listed.',
      openTradesEmptyTitle: 'No open trades here',
      openTradesEmptyLead: 'No collectors on this page have public trade listings right now. Try the next page or search for someone specific.',
      openTradesEmptySearchLead: 'Try another name, or check the next page of collectors.',
      proposeTradeCta: 'Propose trade',
      manageTitle: 'Cards Available for Trade',
      manageLead: 'Manage the cards you currently have available and choose duplicates from your collection to offer for trade.',
      listedTitle: 'Available for Trade',
      listedLead: 'These duplicate copies are visible to other collectors browsing your profile.',
      albumTitle: 'Add Cards from My Collection',
      albumLead: 'Select cards you own, choose how many duplicate copies to list, then save your trade list.',
      listedEmptyTitle: 'You don’t have any cards listed for trade yet.',
      listedEmptyLead: 'Choose duplicates from your collection below to start listing cards for trade.',
      browseCollectionCta: 'Browse My Collection',
      removeConfirmTitle: 'Remove from Trade List?',
      removeConfirmCta: 'Remove from Trade List',
      removeCancelCta: 'Keep Listed',
      pickModalTitle: 'Add to Trade List',
      pickConfirmCta: 'Add to Trade List',
      pickCancelCta: 'Cancel',
      reviewModalTitle: 'Review Trade List',
      reviewModalLead: 'Confirm the cards and quantities you want to list for trade.',
      reviewSaveCta: 'Save Trade List',
      reviewBackCta: 'Back',
      previewCloseCta: 'Close',
      loadingTitle: 'Loading…',
      loadingLead: 'Gathering your trade binder.',
      albumEmptyTitle: 'No duplicates yet',
      albumEmptyLead: 'Pull extra copies from boosters and packs to list them for trade.',
      proposeTitle: 'Propose A Trade',
      proposeLead: 'Pick a collector, choose cards from each side, and send your offer.',
      progressTitle: 'My Trades In-Progress',
      progressLead: 'Review incoming offers and track trades you have sent.',
      emptyTitle: 'Nothing here yet',
      emptyWishlist: 'Mark cards you are searching for from your collection album.',
      emptyTrade: 'Only duplicate copies can be offered for trade.',
      emptyAction: 'Browse collection'
    },
    offers: {
      eyebrow: 'Collector Exchange',
      title: '🤝 Trade Offers',
    ...
    login: {
      ...
      forgotDescription: 'Enter your email and we will send a link to reset your password.',
      resetDescription: 'Choose a new password for your Starlight account.',
      ...
      forgotSentStatus: 'If an account exists for that email, a reset link is on the way. Check your inbox.',
      resetReadyStatus: 'Reset link confirmed. Enter your new password below.',
      resetSuccessStatus: 'Password updated! Taking you to the Binder...'
    },
    shared: {
      infoStripCollection: 'Cards are earned through Free Daily Starlight Packs, reward codes, and special events.',
