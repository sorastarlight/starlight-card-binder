...
export function createDefaultWebsiteContent() {
  return {
    ...
    starlightEvolution: {
      ...
      howLead: 'Open a card in My Starlight Album, then Evolve when you have enough duplicate extras. Each step spends extras and keeps one protected copy.',
      tiersTitle: 'Evolution tiers',
      ownedTitle: 'Your evolved cards',
      ownedLead: 'Cards you have raised above Stardust appear here. Evolve more from Collection full view.',
