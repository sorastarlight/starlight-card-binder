...
function styles(doc){
  ...
  s.textContent=`
.reward-sequence-overlay{position:fixed;inset:0;z-index:2147483000;display:grid;place-items:center;padding:18px;background:rgba(19,25,54,.7);opacity:0;transition:opacity .24s ease;overflow:auto}.reward-sequence-overlay.open{opacity:1}.reward-sequence-stage{--tier:#aee8ff;position:relative;width:min(94vw,590px);padding:22px;border-radius:28px;background:linear-gradient(165deg,rgba(47,55,104,.98),rgba(86,51,111,.98));border:2px solid rgba(255,255,255,.4);box-shadow:0 26px 80px rgba(0,0,0,.38);color:#fff;text-align:center;overflow:hidden;isolation:isolate}.reward-sequence-stage[data-tier=rare]{--tier:#65d8ff}.reward-sequence-stage[data-tier=epic]{--tier:#ff7ee1}.reward-sequence-stage[data-tier=legendary]{--tier:#ffe05a}.reward-tier-aura,.reward-tier-ring,.reward-tier-rays,.reward-tier-stars{position:absolute;inset:0;pointer-events:none;opacity:0;z-index:-1}.reward-tier-aura{background:radial-gradient(circle at 50% 46%,color-mix(in srgb,var(--tier) 58%,transparent),transparent 58%)}.reward-tier-ring{inset:12%;border:2px solid var(--tier);border-radius:50%;box-shadow:0 0 38px var(--tier)}.reward-tier-rays{background:repeating-conic-gradient(from 0deg,transparent 0 14deg,color-mix(in srgb,var(--tier) 45%,transparent) 15deg 17deg,transparent 18deg 30deg);mask:radial-gradient(circle,transparent 0 29%,#000 31% 70%,transparent 72%)}.reward-tier-stars{background-image:radial-gradient(circle,#fff 0 2px,transparent 3px),radial-gradient(circle,var(--tier) 0 2px,transparent 3px);background-size:58px 61px,83px 77px;background-position:10px 20px,37px 8px}.reward-sequence-progress{display:flex;justify-content:center;gap:7px}.reward-sequence-progress span{width:8px;height:8px;border-radius:50%;background:rgba(255,255,255,.25)}.reward-sequence-progress span.active{background:var(--tier);box-shadow:0 0 12px var(--tier)}.reward-sequence-kicker{font-size:.75rem;font-weight:950;letter-spacing:.16em;text-transform:uppercase}.reward-sequence-card-shell{position:relative;width:min(68vw,300px);aspect-ratio:5/7;margin:12px auto;perspective:1700px;cursor:pointer;transform-origin:center center;will-change:transform}.reward-sequence-card-frame{position:absolute;inset:0;overflow:hidden;border-radius:18px;border:2px solid rgba(255,255,255,.88);background:#fff;box-shadow:0 18px 40px rgba(0,0,0,.38);transform-style:preserve-3d;backface-visibility:hidden;will-change:transform}.reward-sequence-card-image{width:100%;height:100%;display:block;object-fit:cover}.reward-sequence-copy{min-height:100px}.reward-sequence-copy h2,.reward-sequence-copy p{margin:6px 0;opacity:0;transform:translateY(8px);transition:.25s ease}.is-revealed .reward-sequence-copy h2,.is-revealed .reward-sequence-copy p{opacity:1;transform:none}.reward-sequence-hint{font-size:.9rem;opacity:.86}.reward-sequence-next{min-width:190px;padding:11px 20px;border:0;border-radius:999px;background:linear-gradient(135deg,#fed334,#ff82c8,#6bc6f8);color:#fff;font-weight:950;opacity:0;pointer-events:none;cursor:pointer}.is-revealed .reward-sequence-next{opacity:1;pointer-events:auto}.reward-sequence-card-shell.enter{animation:rewardEnter .36s ease both}.reward-sequence-card-shell.exit{animation:rewardExit .24s ease both}.reward-sequence-card-shell.flip{animation:rewardFlip .86s cubic-bezier(.22,.7,.2,1) both}
.reward-sequence-stage.is-charging .reward-sequence-card-shell{animation:chargeBuild var(--charge-time,1s) cubic-bezier(.22,.7,.22,1) both}.reward-sequence-stage.is-charging[data-tier=common]{--charge-time:.9s}.reward-sequence-stage.is-charging[data-tier=rare]{--charge-time:1.2s}.reward-sequence-stage.is-charging[data-tier=epic]{--charge-time:1.55s}.reward-sequence-stage.is-charging[data-tier=legendary]{--charge-time:2.15s;animation:legendaryStage 2.15s ease}.reward-sequence-stage.is-charging[data-tier=rare] .reward-tier-ring{opacity:.85;animation:ringBurst 1.2s ease}.reward-sequence-stage.is-charging[data-tier=epic] .reward-tier-ring{opacity:1;animation:ringSpin 1.55s ease}.reward-sequence-stage.is-charging[data-tier=epic] .reward-tier-stars{opacity:.75;animation:starDrift 1.55s ease}.reward-sequence-stage.is-charging[data-tier=legendary] .reward-tier-aura{opacity:1;animation:legendaryAura 2.15s ease}.reward-sequence-stage.is-charging[data-tier=legendary] .reward-tier-ring{opacity:1;animation:legendaryRing 2.15s ease}.reward-sequence-stage.is-charging[data-tier=legendary] .reward-tier-rays{opacity:.8;animation:raySpin 2.15s linear}.reward-sequence-stage.is-charging[data-tier=legendary] .reward-tier-stars{opacity:1;animation:starDrift 2.15s ease}.reward-sequence-stage.is-revealed[data-tier=rare] .reward-sequence-card-frame{box-shadow:0 0 18px rgba(101,216,255,.72),0 18px 40px rgba(0,0,0,.4)}.reward-sequence-stage.is-revealed[data-tier=epic] .reward-sequence-card-frame{box-shadow:0 0 22px rgba(255,126,225,.72),0 0 42px rgba(135,91,255,.3),0 18px 40px rgba(0,0,0,.42)}.reward-sequence-stage.is-revealed[data-tier=legendary] .reward-sequence-card-frame{box-shadow:0 0 24px rgba(255,224,90,.78),0 0 52px rgba(255,105,210,.34),0 18px 45px rgba(0,0,0,.45)}
@keyframes rewardEnter{from{opacity:0;transform:translateY(18px) scale(.94)}to{opacity:1;transform:none}}@keyframes rewardExit{to{opacity:0;transform:translateY(-14px) scale(.95)}}@keyframes rewardFlip{0%{transform:rotateY(0) scale(1.045)}46%{transform:rotateY(88deg) scale(1.07)}54%{transform:rotateY(-88deg) scale(1.07)}100%{transform:rotateY(0) scale(1)}}@keyframes chargeBuild{0%{transform:scale(1) translate3d(0,0,0);filter:brightness(1) saturate(1)}12%{transform:scale(1.01) translate3d(-1px,1px,0)}24%{transform:scale(1.02) translate3d(1px,-1px,0)}36%{transform:scale(1.03) translate3d(-1px,-1px,0)}48%{transform:scale(1.04) translate3d(1px,1px,0)}60%{transform:scale(1.05) translate3d(-1px,1px,0);filter:brightness(1.08) saturate(1.04)}72%{transform:scale(1.06) translate3d(1px,-1px,0)}84%{transform:scale(1.065) translate3d(-1px,1px,0);filter:brightness(1.14) saturate(1.08)}100%{transform:scale(1.07) translate3d(0,0,0);filter:brightness(1.2) saturate(1.1)}}@keyframes ringBurst{from{transform:scale(.45);opacity:1}to{transform:scale(1.35);opacity:0}}@keyframes ringSpin{from{transform:scale(.45) rotate(0)}to{transform:scale(1.3) rotate(420deg);opacity:0}}@keyframes legendaryRing{0%{transform:scale(.25) rotate(0)}65%{transform:scale(1.25) rotate(620deg)}100%{transform:scale(1.65) rotate(760deg);opacity:0}}@keyframes legendaryAura{0%,20%{transform:scale(.4);opacity:0}55%{opacity:1}100%{transform:scale(1.3);opacity:0}}@keyframes raySpin{to{transform:rotate(360deg)}}@keyframes starDrift{from{transform:scale(.7) rotate(-10deg)}to{transform:scale(1.15) rotate(12deg);opacity:0}}@keyframes legendaryStage{35%{box-shadow:0 0 42px rgba(255,224,90,.52),0 0 82px rgba(255,105,210,.34)}70%{transform:scale(1.01)}}@media(prefers-reduced-motion:reduce){*{animation-duration:.01ms!important;transition-duration:.01ms!important}}
`;
...
export function revealRewardSequence(cards=[],options={}){
  ...
  return new Promise(resolve=>{
    ...
    shell.onclick=()=>{if(revealed)advance();else reveal()};shell.onkeydown=e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();if(revealed)advance();else reveal()}};next.onclick=advance;prep();
  });
}
