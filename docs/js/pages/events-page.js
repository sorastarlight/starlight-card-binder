...
let eventsCopy = getCachedWebsiteContent()?.events || {};
...
window.addEventListener('starlight-website-content-hydrated', (event) => {
  eventsCopy = event.detail?.events || eventsCopy;
});
