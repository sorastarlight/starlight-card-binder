...
function wire() {
  ...
  $("#saveDaily")?.addEventListener("click", async () => {
    try {
      ...
      say("Free Daily Starlight Pack availability saved.", "success");
    } catch (e) {
      say(e.message, "error");
    }
  });
