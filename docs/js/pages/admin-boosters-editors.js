    ...
    $("#saveCard").onclick = async () => {
      try {
        ...
        await saveCard({
          ...
          effectStyle: $("#eCardEffectStyle").value || null,
          effectIntensity: $("#eCardEffectStyle").value
            ? Number($("#eCardEffectIntensity").value) || 65
            : null,
