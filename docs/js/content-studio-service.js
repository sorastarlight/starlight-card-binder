...
export async function saveBooster(payload){const {data,error}=await supabase.rpc('admin_save_booster_v9011',{payload});if(error)throw error;return data;}
...
export async function safeDeleteBooster(id){const {data,error}=await supabase.rpc('admin_delete_booster_v9011',{requested_id:id});if(error)throw error;return data;}
