-- Expose equipped avatar frames on public collector rankings.
...
comment on function public.list_public_collector_rankings(text, integer, integer) is
  'Browse and search public collector profiles ranked by collector XP / level. Includes selected title and equipped avatar frame. Collection stats respect show_collection_stats.';
