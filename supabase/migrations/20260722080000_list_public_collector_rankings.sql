-- Public collector rankings: browse/search public profiles by level (collector XP).
...
comment on function public.list_public_collector_rankings(text, integer, integer) is
  'Browse and search public collector profiles ranked by collector XP / level. Collection stats respect show_collection_stats.';
